...
export function AddFacultyModal() {
    ...
    async function onSubmit(data: FacultyFormValues) {
        ...
        try {
            ...
            toast.error(error instanceof Error ? error.message : "Failed to create faculty member")
        } finally {
            setLoading(false)
        }
    }
        ...
        <Dialog open={open} onOpenChange={(isOpen) => isOpen ? setOpen(true) : handleClose()}>
            ...
            <DialogContent className="max-w-lg">
                {createdCredentials ? (
                    <>
                        <DialogHeader>
                            <DialogTitle className="text-green-600">Faculty Member Created!</DialogTitle>
                            <DialogDescription>
                                Share these login credentials with the faculty member. They should change their password after first login.
                            </DialogDescription>
                        </DialogHeader>
                    ...
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Create a new instructor account. They will receive login credentials to access the faculty portal.
                            </DialogDescription>
                        </DialogHeader>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="email" type="email" {...form.register("email")} placeholder="john.smith@lcu.edu" />
